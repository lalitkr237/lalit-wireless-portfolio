...
const publications = [
  {
    ...
    abstract:
      "This work proposes a Doppler-aware, slot-wise CSI acquisition and adaptive reuse framework for 5G NR MU-MIMO systems using SRS-based uplink channel estimation. The framework dynamically updates or reuses CSI based on Doppler conditions and channel condition number to improve spectral efficiency while reducing computational complexity in high mobility wireless environments.",
