...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/lalitkR237",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/lalit-kr-",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Google Scholar",
    url: "https://scholar.google.com/citations?hl=en&user=8tH6wPkAAAAJ",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "ResearchGate",
    url: "https://www.researchgate.net/profile/Lalit-Kumar-Bharti?ev=hdr_xprf",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Email",
    url: "mailto:lalit_2411EE33@iitp.ac.in",
    icon: (
